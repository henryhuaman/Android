...
public class PrincipalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnProf = (Button) v.findViewById(R.id.btnProfesoresF);
        btnCur = (Button) v.findViewById(R.id.btnCursosF);
        ...
        btnCur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.FragPrin, new CursoFragment()).addToBackStack(null).commit();
            }
        });
        ...
        btnProf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.FragPrin, new ProfesorFragment()).addToBackStack(null).commit();
            }
        });
